        ...
        <div className="auth-left-panel">
          <div className="auth-left-content">
            ...
            <div className="auth-welcome-text">
              <h1 className="auth-heading">Welcome to<br />Smart Campus Hub</h1>
              <p className="auth-description">
                Manage campus resources, bookings, and services in one unified platform designed for efficiency.
              </p>
